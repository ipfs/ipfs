...
- [The IPFS Project](#the-ipfs-project)
  - [Current State](#current-state)
  - [Alpha Distribution](#alpha-distribution)
  - [Roadmap and Quarterly Priorities](#roadmap-and-quarterly-priorities)
...
The IPFS project seeks to evolve the infrastructure of the Internet and the Web, with many things we've learned from successful systems such as [Git](https://git-scm.com/), [BitTorrent](http://bittorrent.org/), [Kademlia](https://en.wikipedia.org/wiki/Kademlia), [Bitcoin](https://bitcoin.org/), and many, many others. This is the sort of thing that would have come out of ARPA/DARPA/IETF/BellLabs in another age. IPFS is a Free Open Source project, with hundreds of contributors.

### Current State

**IPFS is a work in progress!**

Please note that IPFS is a work in progress. It is an ambitious plan to make the internet more free, open, secure, and performant. It builds on the good ideas of numerous battle-tested distributed systems.
...
### Roadmap and Quarterly Priorities

To follow along with or contribute to discussions about where the IPFS Project is headed, visit our [IPFS Team Planning, Management, and Coordination repo](https://github.com/ipfs/team-mgmt).
...
This aims to be a directory of all the various repos and forums in the [IPFS Github Organization](https://github.com/ipfs).
...
- [team-mgmt](https://github.com/ipfs/team-mgmt) - IPFS team planning, management, and  coordination.
...
- [newsletter](https://github.com/ipfs/newsletter) - Prepares and stores IPFS Newsletter roundups. [Subscribe here.](https://tinyletter.com/ipfsnewsletter)
...
- [website](https://github.com/ipfs/website) - The source for http://ipfs.io.
- [docs](https://github.com/ipfs/docs) - The source for http://docs.ipfs.io.
...
ProtoSchool is an educational community that teaches decentralized web protocols and tools through online tutorials and local chapter events. Check it out at https://proto.school, where you can explore self-guided interactive tutorials, and/or [contribute your own tutorials](https://github.com/ProtoSchool/protoschool.github.io#developing-tutorials).

To learn more about local chapters or start your own, visit [https://github.com/protoschool/organizing](https://github.com/protoschool/organizing).
...
The IPFS Project is big -— there are many sub-projects and related efforts. We will document the core ones here, though you should look around. The space is exploding and lots of new projects are springing up all the time.
