...
All client maintainers are added to a team in this org called @ipfs-http-client-maintainer. Please log an issue in
this repository if you are a client maintainer and are not in the list below and/or on the team yet.

| Language      | Client Library                                            | Maintainers |
|---------------|-----------------------------------------------------------|--------------|
